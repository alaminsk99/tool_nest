...
import 'package:toolest/application/blocs/auth/auth_bloc.dart';
import 'package:toolest/application/blocs/auth/auth_event.dart';
...
import 'package:toolest/domain/models/image_tools/image_format_converter_model.dart';
...
import 'package:toolest/presentation/pages/main_page.dart';
import 'package:toolest/presentation/pages/profile/auth/login/login_page.dart';
import 'package:toolest/presentation/pages/profile/profile_page.dart';
import 'package:toolest/presentation/pages/profile/widgets/webview_page.dart';
import 'package:toolest/presentation/pages/settings/settings_page.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_compressor/image_compress_result.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_format_convert/image_format_converter_page.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_format_convert/image_format_converter_result.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_format_convert/image_format_converter_settings.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_to_pdf/image_to_pdf_page.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_to_pdf/image_to_pdf_settings.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_to_pdf/image_to_pdf_result.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_to_pdf/widgets/image_preview_card.dart';
import 'package:toolest/presentation/pages/tools/image_tools/image_to_pdf/widgets/process_finished_for_image_to_pdf.dart';
import 'package:toolest/presentation/pages/tools/image_tools/resize_image/image_resize_page.dart';
import 'package:toolest/presentation/pages/tools/image_tools/resize_image/image_resize_result.dart';
import 'package:toolest/presentation/pages/tools/image_tools/resize_image/image_resize_settings.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/compress_pdf/compress_pdf_page.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/compress_pdf/compress_pdf_result.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/compress_pdf/compress_pdf_settings.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/merge_pdf/merge_pdf_page.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/merge_pdf/merge_pdf_result.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/merge_pdf/merge_pdf_settings.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/pdf_to_Image/pdf_to_image_page.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/pdf_to_Image/pdf_to_image_result.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/pdf_to_Image/pdf_to_image_settings.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/split_pdf/split_pdf_page.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/split_pdf/split_pdf_result.dart';
import 'package:toolest/presentation/pages/tools/pdf_tools/split_pdf/split_pdf_settings.dart';
  ...
  routes: [
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: AppRoutes.webViewsPath,
          name: AppRoutes.webViews,
          builder: (context, state) {
            final model = state.extra as WebViewModel;
            return WebViewPage(model: model);
          },
        ),
        // Image Tools
        GoRoute(
